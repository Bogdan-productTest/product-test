...
public class GetNameShop {
    ...
    public static void parseXML() throws IOException {
        ...
        // Read XSL file
        FileInputStream inputStream = new FileInputStream(new File("C:/Users/Mirror/Desktop/product-test/тест9.xls"));
    ...
    public static void createFile () throws IOException {
        File file = new File("C:/Users/Mirror/Desktop/product-test/результат" + x + ".xls");
