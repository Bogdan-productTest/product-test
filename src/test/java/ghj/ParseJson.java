...
public class ParseJson {
    ...
    public static void parseNadavi(String id, String url, int k) throws Exception {
        ...
        String s = "http://info.price.nadavi.ru/p4g3.php?p4g_api_type_=json&p4g_partner_=77800&p4g_name_=Puky%204102%20Z2%20Lovely%20Pink&p4g_yid_="+ id +"&p4g_u_ip_=77.72.253.17";
...
//            System.out.println(o.getString("OfferName"));
            sheet.getRow(k-1).createCell(i+4).setCellValue(o.getString("OfferName"));
    ...
    public void createFile () throws IOException {
        File file = new File("C:/Users/Тестер/Desktop/ParseSmartfonyResult.xls");
